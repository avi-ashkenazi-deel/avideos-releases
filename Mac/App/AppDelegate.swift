...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        //
        // Note the companion rule in StudioController: subsystems must not
        // start before NSApplicationMain either, or they race AppKit for the
        // process's window-server registration and the app launches unable to
        // be activated at all. Ignition happens in bootSubsystems(), from
        // onAppear.
