...
- [ ] Screen recorded locally: share during a take → a third "screen" lane uploads; stop the share mid-take, import, and "<name>'s Screen" lands as its own lane at the right moment, cuttable from the Cut to strip.
